...
<div  ng-app="addToCartApp"  ng-controller = "addToCartCtrl"  ng-init="retrieveCart('${cartId}')">
		  ...
		  <thead>
			...
			<tbody>
			 ...
			 <tr>
					...
					<td></td>
                    <td>Grand Total of no.items</td>
                    <td>GrandTotal in (Rs.)</td>
                </tr> 
			</tbody> 
		  </table>
 ...
 cartApp.controller("addToCartCtrl", function ($scope, $http){
     ...
     $scope.removeItemFromCart = function (name) {
         $http.put('http://localhost:9080/pizzaworld/categoryDropdown/productDisplay/usercart/cart/removeItem/'+name).success(function (data) {
