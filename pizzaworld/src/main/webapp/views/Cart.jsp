...
body {
	background-image: url("https://encrypted-tbn1.gstatic.com/images?q=tbn:ANd9GcQX2ERnADOl4ZNrT8ml1aN3ljQvzlMIlxD29WLRD2UfiNmEElhU");
...
<body>
	...
	<header>
	<h1 style="font-family:Bell MT;color:white;">PIZZA WORLD</h1>
	<h5 style="font-family:Bell MT;color:white;">(Better Ingredients...Better Pizza)</h5>
...
<script>
 ...
 cartApp.controller("addToCartCtrl", function ($scope, $http){
     ...
     $scope.removeItemFromCart = function (id) {
         $http.put('http://localhost:9080/pizzaworld/categoryDropdown/productDisplay/usercart/cart/removeItem/'+id).success(function (data) {
     ...
     $scope.addItemToCart = function (id) {
         $http['delete']('http://localhost:9080/pizzaworld/usercart/cart/addItem/'+id).success(function (data) {
     ...
     $scope.refreshCartItems = function () {
         $http.get('http://localhost:9080/pizzaworld/categoryDropdown/productDisplay/usercart/cart/refreshCart/'+$scope.cartId).success(function (data) {
            $scope.cart=data;
         });
     };
     ...
     $scope.clearCartItems = function () {
     	$http['delete']('http://localhost:9080/pizzaworld/categoryDropdown/productDisplay/usercart/cart/clearCartItems/'+$scope.cartId).success(function (data)
     			{$scope.refreshCartItems()
     		});
     };
 });
