...
<a href="category"><button type="button" class="btn btn-primary" >back to categories</button></a>
 <script>
 ...
 cartApp.controller("addToCartCtrl", function ($scope, $http){
     ...
     $scope.removeItemFromCart = function (id) {
         $http.put('http://localhost:8080/kafon/removeItem/'+id).success(function (data) {
     ...
     $scope.addItemToCart = function (id) {
         $http.put('http://localhost:8080/pizzafrontend/categoryDropdown/productDisplay/usercart/cart/addItem/'+id).success(function (data) {
